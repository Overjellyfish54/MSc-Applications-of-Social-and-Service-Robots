...
def saved_name():
    try:
        with open("./NAO-ROBOT/Social_Service/registration/face_name.txt", "r") as f:
...
ANIMATION_MAP = {
    ...
    "week5-8_exercise1.py": "C:/Users/elwoo/Documents/coding/python/NAO-ROBOT/Social_Service/animations/week5-8_exercise1.py",  
    "week5-8_exercise2.py": "C:/Users/elwoo/Documents/coding/python/NAO-ROBOT/Social_Service/animations/week5-8_exercise2.py",
    "week5-8_exercise3.py": "C:/Users/elwoo/Documents/coding/python/NAO-ROBOT/Social_Service/animations/week5-8_exercise3.py",
}
...
EXERCISE_EXPLANATION = {
    ...
    "week5-8_exercise3.py": "Using a tennis ball, roll it on a table, forwards and backwards or side to side. Place the ball on a book or tray and roll from side to side in a controlled way as shown. Complete each activity for 1 minute. I will now demonstrate the exercise to you.",
}
...
tts.say("So, " + getname + " you are now onto the later weeks exercise section. In this section we will go over several exercises to aid in your rehabilitation after full elbow replacement surgery. These exercises are important for the full recovery of your elbow joints post replacement surgery, I will give an explanation of the exercise and demonstrate them visually to you. Each time, please tell me the number of the exercise you would like to do from your NHS pamphlet and the week range it falls under. Also, because you are in weeks 5 to 8 you can also request that I go over exercises from the first 4 weeks again. Okay, we will start now.")
...
tts.say("Thank you for coming to this guided physiotherapy session, remember to do these exercises outside of these sessions and as you are in weeks 5 to 8 you are encouraged to also do the exercises from the first four weeks. I will see you again in a few weeks for another round of exercises.")